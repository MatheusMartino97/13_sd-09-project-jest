...
describe('quem sobreviveu?', () => {
  ...
  afterEach(() => {
    const aventureiros = adventure.specialists
    .map(aventureiro => ` ${aventureiro.nome}`)

    console.log(`Sobreviventes:${aventureiros}`)
  })
  ...
  test('depois da quinta aventura', () => {
    ...
    console.log(`O único sobrevivente foi o ${adventure.specialists[0].nome}`)
  });
});
